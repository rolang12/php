        ...
        <div class="container-fluid   ">
            ...
            <div class="min-h-screen  justify-center  flex items-center text-center  ">
                ...
                <div>
                    ...
                    <h2 class="mt-6 text-center text-4xl font-bold text-gray-500">Log In</h2>
                ...
                <form class="mt-2 space-y-6" action="validation.php"  method="post"  >
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input type="checkbox" class="h-4 w-4 text-gray-600 focus:ring-gray-500 border-gray-300 rounded">
                    ...
                    <div>
                        <button type="submit"  value="login" class="group relative modal-open w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
