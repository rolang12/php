...
<head>
    ...
    <link rel="stylesheet" href="../../Tailwind/estilos">
    <link rel="stylesheet" href="../../Tailwind/est.css">
    <link rel="stylesheet" href="../../Tailwind/final.css">
        ...
        <div class="container-fluid   ">
            ...
            <div class="min-h-screen  justify-center  flex items-center text-center  ">
                ...
                <div>
                    ...
                    <h2 class="mt-6 text-center text-4xl font-bold text-gray-500">Edit Account</h2>

                    
                </div>
                <form class="mt-8 space-y-6" method="POST" action="../Views/users/editProfileDone.php?edit=1" enctype="multipart/form-data" >
                        
                    <input type="hidden" name="newidusuarios" value="<?php echo $action->iduser?> ">

                        
                    <div class="rounded-md shadow-sm ">

                        <div class=" my-2 ">
                            <input value="<?php echo $action->nickName; ?>" type="text" name="newnickname" class="  block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Nickname" required >
                        </div>

                        <div class=" my-2 ">
                            <input value="<?php echo $action->passwor;?>" type="password" name="newpassword" class=" block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Password" required >
                        </div>

                        <div class=" my-2 ">
                            <input value="<?php echo $action->email;?>" type="email" name="newemail"  class="  block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Email" required >
                        </div>


                        <div class=" my-2 ">
                            <input disabled value="<?php echo $action->name; ?>" type="direccion" name="direccion" class=" block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Dirección" required >
                        </div>

                        <div class=" my-2 ">
                            <input  value="<?php echo $action->avatar; ?>" type="file" name="avatar" accept="image/png, image/jpeg" class=" block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" >
                        </div>
