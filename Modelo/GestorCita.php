...
class GestorCita {
    ...
    public function consultarCitaPorId($id){
        ...
        $sql = "SELECT pacientes.* , medicos.*, consultorios.*, citas.* FROM Pacientes as pacientes, Medicos as medicos, Consultorios as consultorios ,citas WHERE citas.CitPaciente = pacientes.PacIdentificacion 
        AND citas.CitMedico = medicos.MedIdentificacion  AND citas.CitNumero = $id";
