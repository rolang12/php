    ...
    <body class="bg-image " >
        ...
        <div class="container-fluid   ">
            ...
            <div class="min-h-screen  justify-center  flex items-center text-center  ">
                ...
                <form class="mt-8 space-y-6" action="../../Views/users/regProfileDone.php" method="POST" enctype="multipart/form-data" >
                       
        
                    <div class="rounded-md shadow-sm ">

                        <div class=" my-2 ">
                            <input  type="text" name="nickname" class="  block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Nickname" required >
                        </div>

                        <div class=" my-2 ">
                            <input type="password" name="password" class=" block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Password" required >
                        </div>

                        <div class=" my-2 ">
                            <input type="email" name="email"  class="  block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Email" required >
                        </div>

                        <div class=" my-2 ">
                            <select type="text" name="pais" class=" block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Pais" required >
                        ...
                        <div class=" my-2 ">
                            <input  type="text" name="direccion" class=" block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" placeholder="Dirección" required >
                        </div>

                        <div class=" my-2 ">
                            <input  type="file" name="avatar" accept="image/png, image/jpeg" class=" block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm" >
                        </div>
